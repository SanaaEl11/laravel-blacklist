...
<head>
    ...
    <link href="https://unpkg.com/bs-brain@2.0.4/components/registrations/registration-12/assets/css/registration-12.css" rel="stylesheet">
    <style>
        .link-warning { color: #ffc107; }
        .link-warning:hover { color: #e0a800; }
        .text-light-dark { color: #6c757d; }
...
<section class="py-3 py-md-5 py-xl-8">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="mb-5">
                    <h2 class="display-5 fw-bold text-center">Se connecter</h2>
                    <p class="text-center m-0">Vous n'avez pas de compte ? <a href="{{ route('register') }}" class="link-warning text-decoration-none">S'inscrire</a></p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="row gy-3 overflow-hidden">
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="password" class="form-control border-0 border-bottom rounded-0" id="motdepasse" name="motdepasse" placeholder="Password" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex justify-content-center mb-4">
                                        <a  class="text-decoration-none link-warning">Mot de passe oublié ?</a>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="d-grid">
                                        <button class="btn btn-lg btn-dark rounded-0 fs-6" type="submit">Se connecter</button>
                                    </div>
                                </div>
                            </div>
                        </form>
